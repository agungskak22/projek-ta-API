...
<footer class="footer">
    <div class="container">
        <span class="left span-padding grey-text text-lighten-4"> Copyright © 2019 <a class="grey-text text-lighten-4" href="#" target="_blank">Agung Prio Rismawan</a> All rights reserved.</span>

        <span class="right span-padding grey-text text-lighten-4"> Design and Developed by <a class="grey-text text-lighten-4" href="#" target="_blank">Agung Prio Rismawan</a></span>
    </div>
</footer>
<!-- END FOOTER -->
